    ...
    public static byte[] encodeBytesToBytes( byte[] source, int off, int len, int options ) throws java.io.IOException {
        ...
        if( (options & GZIP) != 0 ) {
            ...
            try {
                ...
                try{ if(gzos!=null) {gzos.close();}  } catch( IOException e ){}  catch( NullPointerException e ){}
                try{ if(b64os!=null) {b64os.close();} } catch( IOException e ){}  catch( NullPointerException e ){}
                try{ if(baos!=null) {baos.close();}  } catch( IOException e ){}  catch( NullPointerException e ){}
            }   // end finally
        ...
        if( (bytes != null) && (bytes.length >= 4) && (!dontGunzip) ) {
            ...
            if( java.util.zip.GZIPInputStream.GZIP_MAGIC == head )  {
                ...
                try {
                    ...
                    try{ if(baos!=null) {baos.close();}   } catch( IOException e ){}
                    try{ if(gzis!=null) {gzis.close();}  } catch( IOException e ){}
