...
public interface Growler {
	...
	/** Show a message to the user with a given title/message/icon. */
	void show(Level logLevel, String message, String title, boolean sticky, ImageIcon imageIcon);

	/** Display a message.  */
	public abstract void show(Level logLevel, JPanel messagePanel, String title, boolean sticky);
